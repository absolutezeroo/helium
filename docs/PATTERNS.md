...
```typescript
/**
 * @see sources/win63_version/habbo/communication/messages/parser/handshake/AuthenticationOKMessageParser.as
 */
```
...
- Use `@see sources/win63_version/...` for specific file references
