...
export class FurnitureVisualization extends RoomObjectSpriteVisualization
{
	...
	protected updateObject(scale: number, geometryDirection: number): boolean
	{
		...
		if (this._updateModelCounter !== roomObject.getUpdateID() || scale !== this._scale || geometryDirection !== this._geometryDirection)
		{
			...
			this._updateModelCounter = roomObject.getUpdateID();
