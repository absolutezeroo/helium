...
export class Animation implements IAnimation
{
    ...
    public hasAvatarData(): boolean { return this._avatarData != null; }
    public hasDirectionData(): boolean { return this._directionData != null; }
    public hasAddData(): boolean { return this._addData != null; }

    public get id(): string { return this._id; }
    public get spriteData(): ISpriteDataContainer[] { return this._spriteData || []; }
    public get avatarData(): AvatarDataContainer | null { return this._avatarData; }
    public get directionData(): DirectionDataContainer | null { return this._directionData; }
    public get removeData(): string[] { return this._removeData || Animation.EMPTY_ARRAY; }
    public get addData(): AddDataContainer[] { return this._addData || Animation.EMPTY_ARRAY as AddDataContainer[]; }
    public get resetOnToggle(): boolean { return this._resetOnToggle; }

    public toString(): string { return this._description; }
}
