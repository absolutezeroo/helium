...
export class AvatarImagePartContainer
{
    ...
    private _blendTransform: { redMultiplier: number; greenMultiplier: number; blueMultiplier: number; alphaMultiplier: number };
    ...
    public get bodyPartId(): string { return this._bodyPartId; }
    public get partType(): string { return this._partType; }
    public get partId(): string { return this._partId; }
    public get color(): IPartColor | null { return this._color; }
    public get action(): IActionDefinition { return this._action; }

    public get isColorable(): boolean { return this._isColorable; }
    public set isColorable(value: boolean) { this._isColorable = value; }

    public get paletteMapId(): number { return this._paletteMapId; }
    public get flippedPartType(): string { return this._flippedPartType; }
    public get isBlendable(): boolean { return this._isBlendable; }

    public get blendTransform(): { redMultiplier: number; greenMultiplier: number; blueMultiplier: number; alphaMultiplier: number }
    {
