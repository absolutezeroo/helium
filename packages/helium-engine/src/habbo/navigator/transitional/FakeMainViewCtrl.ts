...
export class FakeMainViewCtrl implements ITransitionalMainViewCtrl
{
    ...
    private getSearchCodeByLegacySearchType(searchType: number): string
    {
        switch(searchType)
        {
            ...
            case 2: return 'highest_score';
            case 3: return 'friends_rooms';
            case 4: return 'with_friends';
            case 5: return 'my';
            case 6: return 'favorites';
            case 7: return 'history';
            case 8: return 'query';
            case 9: return 'query';
            case 10: return 'query';
            case 11: return 'official';
            case 12: return 'new_ads';
            case 13: return 'groups';
            case 14: return 'groups';
            case 15: return 'competition';
            case 16: return 'top_promotions';
            case 17: return 'new_ads';
            case 18: return 'with_rights';
            case 19: return 'my_groups';
            case 20: return 'query';
            case 21: return 'all_categories';
            case 22: return 'recommended';
            case 23: return 'history_freq';
