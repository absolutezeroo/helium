...
const splashModules = import.meta.glob('./assets/images/splash_img*.png') as Record<string, () => Promise<{ default: string }>>;
...
export class LoadingScreen
{
     ...
     */
    private createLoadingBar(): { outer: HTMLDivElement; track: HTMLDivElement; fillTop: HTMLDivElement; fillBottom: HTMLDivElement }
    {
