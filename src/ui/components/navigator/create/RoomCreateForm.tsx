...
import {NavigatorIcon, NavigatorButton} from '../common';
    ...
    return (
        ...
        >
            ...
            <Show when={props.error}>
                <div class="flex items-center gap-2 p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 text-sm">
            ...
            <div>
                ...
                />
                <div class="flex justify-end mt-1">
                    <span class={`text-xs ${description().length > maxDescLength() ? 'text-red-400' : 'text-slate-500'}`}>
                        {description().length}/{maxDescLength()}
                    </span>
                </div>
            </div>
