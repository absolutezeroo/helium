...
const iconPaths: Record<IconName, string> = {
	...
	compass: 'M21 12a9 9 0 11-18 0 9 9 0 0118 0z M9 9l3 3m0 0l3-3m-3 3l-3 3m3-3l3 3',
	...
	enter: 'M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1',
	...
	heartFilled: 'M3.172 5.172a4 4 0 015.656 0L12 8.344l3.172-3.172a4 4 0 115.656 5.656L12 19.656l-8.828-8.828a4 4 0 010-5.656z',
	...
	crown: 'M5 3l3.5 7L12 6l3.5 4L19 3l-2 18H7L5 3z',

	// Other
	tag: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z',
	calendar: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
	pet: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
...
export function NavigatorIcon(props: NavigatorIconProps): JSX.Element
{
	...
	// Special handling for loading icon (filled path)
	if (props.name === 'loading')
	{
		return (
			...
			>
				<path d={iconPaths.loading}/>
			</svg>
		);
	}

	// Special handling for filled icons
	if (props.name === 'heartFilled' || props.name === 'starFilled')
	{
		return (
			<svg
				class={`${size()} ${props.class ?? ''}`}
