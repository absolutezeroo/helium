...
import {NavigatorMetaDataMessageEvent} from '@habbo/communication/messages/incoming/newnavigator/NavigatorMetaDataMessageEvent';
import {NavigatorSearchResultSetMessageEvent} from '@habbo/communication/messages/incoming/newnavigator/NavigatorSearchResultSetMessageEvent';
...
import {GuestRoomSearchResultMessageEvent} from '@habbo/communication/messages/incoming/navigator/GuestRoomSearchResultMessageEvent';
import {PopularRoomTagsResultMessageEvent} from '@habbo/communication/messages/incoming/navigator/PopularRoomTagsResultMessageEvent';
import {NavigatorSettingsMessageEvent} from '@habbo/communication/messages/incoming/navigator/NavigatorSettingsMessageEvent';
import {NewNavigatorSearchComposer} from '@habbo/communication/messages/outgoing/newnavigator/NewNavigatorSearchComposer';
import {GetGuestRoomMessageComposer} from '@habbo/communication/messages/outgoing/navigator/GetGuestRoomMessageComposer';
...
import type {NavigatorTopLevelContext} from '@habbo/communication/messages/incoming/newnavigator/NavigatorTopLevelContext';
import type {NavigatorSearchResultSet} from '@habbo/communication/messages/incoming/newnavigator/NavigatorSearchResultSet';
import type {GuestRoomSearchResultData} from '@habbo/communication/messages/incoming/navigator/GuestRoomSearchResultData';
...
const actions = {
	...
	setDoorData(data: Partial<DoorData>)
	{
