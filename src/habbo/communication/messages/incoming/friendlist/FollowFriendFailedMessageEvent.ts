 ...
 *
 * @see source_as/habbo/communication/messages/incoming/friendlist/FollowFriendFailedEvent.as
 */
export class FollowFriendFailedMessageEvent extends MessageEvent
{
